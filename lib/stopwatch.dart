...
class StopWatchState extends State<StopWatch> {
  ...
  // @override
  // void initState() { // fungsi yang memastikan setiap variabel terdapat isi
  //   isTicking = true;
  //   super.initState();
  //   seconds = 0;
  //   timer = Timer.periodic(Duration(seconds: 1), _onTick); // menginisialisasi awal duration
  // }
  ...
  //String _secondsString() => seconds == 1 ? 'second' : 'seconds'; // kalau true dia akan jalanin yg 'second' kalau false seconds
